...
export class HeroesService {
  ...
  arrayFilter : InterfaceHeroGeneral[] = [];
  ...
  public filterHeroes(id: number, sex: string, align: string, stats: string):Observable<InterfaceFilteHeroes>{
    const Url = `https://www.superheroapi.com/api.php/10217431065143700/${id}`;
    return this.http.get(Url).pipe(
  ...
  pushFilter(filtrado: InterfaceHeroGeneral[]){
